 ...
 */
const TRANSITION_TABLE: Record<string, Record<string, QuoteStep[]>> = {
 ...
 */
export function buildSteps(prevStatus: string | null | undefined, nextStatus: string): QuoteStep[] {
 ...
 */
export function buildContentChangeSteps(prevStatus: string): QuoteStep[] {
